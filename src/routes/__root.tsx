    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-2xl bg-primary px-5 py-2.5 text-sm font-medium text-primary-foreground shadow-glow transition hover:bg-primary/90"
          >
            Go home
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "CropGuard AI — Protect Your Crops with AI" },
      {
        name: "description",
        content:
          "AI-powered crop disease detection, weather intelligence, and personalized farming guidance for modern growers.",
      },
      { property: "og:title", content: "CropGuard AI — Protect Your Crops with AI" },
      {
        property: "og:description",
        content:
          "Scan any crop leaf and get instant disease diagnosis, severity, and a full treatment plan.",
      },
